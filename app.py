...
st.caption(
    "Black mask pixels are fully transparent; coloured class pixels are semi-transparent."
)
st.divider()

# ── Top: two individual comparison sliders ─────────────────────────────────────
col_l, col_r = st.columns(2, gap="large")

with col_l:
    st.subheader("Overlay — Mask 1")
    image_comparison(img1=img0, img2=overlay1, label1="Base", label2="Mask 1",
                     starting_position=50, show_labels=True, make_responsive=True, in_memory=True)

with col_r:
    st.subheader("Overlay — Mask 2")
    image_comparison(img1=img0, img2=overlay2, label1="Base", label2="Mask 2",
                     starting_position=50, show_labels=True, make_responsive=True, in_memory=True)
